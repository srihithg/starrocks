...
public class TransactionLoadActionTest extends StarRocksHttpTestCase {
    ...
    // handler's post-eviction source guard (assertCachedOutcomeIsBypassWrite) can be exercised end to end
    // through routing -> handler -> commitEvictedByLabel, not just as an isolated unit.
    ...
    public void commitEvictedNonBypassOutcomeByLabelRejected() throws Exception {
        ...
        // preserving the live-path check across count eviction.
    ...
    public void commitEvictedNullSourceOutcomeByLabelRejected() throws Exception {
        // A null/unknown source is fail-closed: rejected rather than answered off an untyped outcome.
