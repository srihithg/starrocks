...
public class Config extends ConfigBase {
     ...
     * finish time, source type); entries older than *label_keep_max_second* are treated as absent. The cache is
     * in memory only, so an FE restart falls back to "transaction not found". Set to 0 to disable
     * the cache.
     */
    @ConfField(mutable = true)
